    ...
    " class="flex h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div id="alert-section">
                ...
                @if(Auth::check() && !\App\Http\Controllers\AcuerdoConfidencialidadController::tieneAcuerdoConfidencialidad(Auth::id()))
                    <div class="bg-yellow-500 text-white p-4 rounded mb-4 dark:bg-yellow-700">
                        <div class="flex items-center">
                            ...
                            <span>{{ __('No tienes un acuerdo de confidencialidad registrado.') }} <a href="{{ route('acuerdos-confidencialidad.create') }}" class="underline font-bold">Registrar ahora</a></span>
                        </div>
                    </div>
                @endif
            </div>
