        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <p class="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200">Completa el Registro</p>
                    <p class="text-gray-600 dark:text-gray-400 mb-6">Bienvenido, {{ Auth::user()->name }}.</p>
                    @if(session('success'))
                    ...
                    <form action="{{ route('profile.storeComplete') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" id="phone" class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-300" value="{{ old('phone', $profile->phone ?? '') }}">
                            </div>
                            <div class="form-group">
                                <label for="birth_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Fecha de Nacimiento</label>
                                <input type="date" name="birth_date" id="birth_date" class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-300" value="{{ old('birth_date', $profile->birth_date ?? '') }}">
                            </div>
                            <div class="form-group">
                                <label for="gender" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Género</label>
                                <select name="gender" id="gender" class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-300">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="cedula" id="cedula" class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-300" value="{{ old('cedula', $profile->cedula ?? '') }}">
                            </div>
                            <div class="form-group">
                                <label for="direccion_calle" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Dirección Calle</label>
                            ...
                            <div class="form-group">
                                <label for="direccion_ciudad" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Dirección Ciudad</label>
                            ...
                            <div class="form-group">
                                <label for="direccion_provincia" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Dirección Provincia</label>
                            ...
                            <div class="form-group">
                                <label for="numero_referencia" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Número de Referencia</label>
                        ...
                        <div class="form-group">
                            <label for="acta_grado" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Acta de Grado</label>
