<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8"> <!-- Ajusté el max-width para reducir el ancho -->
                            ...
                            @foreach ($cursos as $curso)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-4 py-2 text-sm font-medium flex items-center justify-center space-x-2">
                                        <a href="{{ route('cursos.edit', $curso) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                                            Editar
                                        </a>
