            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mt-4 overflow-x-auto">
                        <table class="table-auto mx-auto divide-y divide-gray-200 border">
                                ...
                                @foreach ($cursos as $curso)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-4 py-2 text-sm font-medium flex items-center justify-center space-x-2">
                                            ...
                                            <form action="{{ route('cursos.destroy', $curso) }}" method="POST" class="inline-block" onsubmit="return confirm('¿Estás seguro de eliminar este curso?');">
                                                @csrf
                                                @method('DELETE')
